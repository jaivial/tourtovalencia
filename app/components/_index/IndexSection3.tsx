  ...
  return (
    <div className={`w-[95%] max-w-[1280px] flex flex-row flex-wrap items-center justify-center my-20 mx-auto relative z-0`}>
      <motion.div 
        ...
        viewport={{ once: true }}
        className={`w-full flex ${width <= 1024 ? "flex-col" : "flex-row"} items-center justify-center max-w-[1180px] gap-8 backdrop-blur-sm bg-white/5 rounded-3xl p-8 shadow-lg`}
      >
        {/* Image Section */}
        <motion.div 
