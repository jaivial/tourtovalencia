  ...
  return (
    <>
      <motion.div
        ...
        className="w-[95%] max-w-[1280px] mx-auto relative z-0"
      >
        {width > 580 ? (
          <div className="flex flex-col items-center justify-center my-10 gap-6 overflow-x-hidden">
            <motion.div 
