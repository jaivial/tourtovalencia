...
const SanJuanSection5: React.FC<ChildProps> = ({ width, SanJuanSection5Text }) => {
  ...
  return (
    <div className="w-[95%] max-w-[1280px] mx-auto my-2 flex flex-col items-center justify-center relative z-0">
      {/* Title Section */}
      <div className={`
      ...
      {/* Content Section */}
      <div className="w-full flex flex-row flex-wrap justify-center items-center p-6 gap-8 -translate-y-[40px]">
        <img 
          src="/plazareina2.jpg" 
          alt="Viajes en Barca en San Juan desde Valencia. BOAT TRIP AND EXCURSION FROM VALENCIA" 
          className="rounded-2xl max-h-[350px] object-cover shadow-lg hover:scale-[1.02] transition-transform duration-300"
        />
        
        <div className={`
          flex flex-col gap-3 my-auto leading-
