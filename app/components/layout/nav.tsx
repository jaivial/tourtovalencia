      ...
      {clientWidth >= 1280 ? (
        ...
        >
          ...
          <div className="w-[45px]" />
           <img src="https://tourtovalencia.b-cdn.net/public/newtourtovalencialogo.png" alt="Olga Travel" loading="eager" className={` ${clientWidth < 380 ? "h-[20px]" : "h-[80px]"} py-2 absolute left-1/2 -translate-x-1/2 w-auto`} />
        ...
        >
            <LanguageSelector />
          <img src="https://tourtovalencia.b-cdn.net/public/newtourtovalencialogo.png" alt="Olga Travel" className={` ${clientWidth < 380 ? "h-[50px]" : clientWidth < 450 ? "h-[50px]" : clientWidth < 500 ? "h-[50px]" : "h-[50px]"}`} />
          <div className="flex items-center gap-3">
            ...
            >
              <div className="flex flex-col w-full min-h-full justify-between py-4">
                <div className="flex flex-col gap-6">
                   <img src="https://tourtovalencia.b-cdn.net/public/newtourtovalencialogo.png" alt="Olga Travel" loading="lazy" className={`${clientWidth < 380 ? "h-[60px]" : "h-[80px]"} mx-auto mb-4`} />
