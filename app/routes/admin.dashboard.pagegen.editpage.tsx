...
// Define a type for the jsonified version of Page
type JsonifiedPage = {
  _id: string;
  name: string;
  slug: string;
  ...
  template?: string;
  createdAt: string; // Date is serialized as string
  updatedAt: string; // Date is serialized as string
  content: {
...
export default function EditPageRoute() {
  const { pages } = useLoaderData<{ pages: JsonifiedPage[] }>();
  const { 
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex space-x-2">
                            ...
                            <Button 
                              ...
                              onClick={() => handleDeleteConfirmation(page as unknown as Page)}
                            >
