...
export default function ValenciaSEO() {
  ...
  // Function to handle smooth scrolling to the explore section with animation
  const handleExploreClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    if (exploreRef.current) {
      ...
      const targetPosition = exploreRef.current.offsetTop;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center pt-[120px]">
          ...
          >
            <motion.a 
              ...
              aria-label="Explore Valencia content"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              animate={isScrolling ? { y: [0, 10, 0], transition: { repeat: Infinity, duration: 1 } } : {}}
            >
              {text.exploreButton}
              <motion.svg 
                ...
                viewBox="0 0 20 20" 
                fill="currentColor"
                animate={isScrolling ? { y: [0, 5, 0], transition: { repeat: Infinity, duration: 1 } } : {}}
              >
      ...
      <section id="explore" ref={exploreRef} className="py-20 container mx-auto px-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
